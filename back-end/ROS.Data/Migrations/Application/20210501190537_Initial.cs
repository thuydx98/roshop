        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreNote = table.Column<string>(type: "text", nullable: true),
                    ShippingFee = table.Column<decimal>(type: "numeric", nullable: false),
                    ShippingService = table.Column<string>(type: "text", nullable: true),
                    ...
                    OrderedTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    ShippedTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductVotes_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductVotes_Users_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVotePhotos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductVotePhotos_ProductVotes_VoteId",
                        column: x => x.VoteId,
                        principalTable: "ProductVotes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVotePhotos_VoteId",
                table: "ProductVotePhotos",
                column: "VoteId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductVotes_AuthorId",
                table: "ProductVotes",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductVotes_OrderId",
                table: "ProductVotes",
                column: "OrderId");
